...
**Run locally:** set `TELEGRAM_BOT_TOKEN`, then `cd bot && go run ./cmd/bot`. **Docker:** from the repo root, `docker compose build bot && docker compose up bot` (see [`compose.yaml`](compose.yaml)).

**Sandbox runbook and acceptance:** [specs/001-lifesoundtrack-bot-commands/quickstart.md](specs/001-lifesoundtrack-bot-commands/quickstart.md).
